...
class GuardarDibujoEnImagen():
    ...
    def figura_a_png(self,generar_dibujo_en_formato,name_figure,size,pos,color_relleno,tipo_de_linea,coords_borde,color_borde,line_width,angle_start=0,angle_end=0): 
        ...
        if generar_dibujo_en_formato:
            ...
            ruta = './modulos/pytikz/recursos/crear_imagen/grafica_original/'+nombre_img
            ...
            ruta = './modulos/pytikz/recursos/crear_imagen/grafica_recortada/'+nombre_img
    ...
    def __crear_imagen(self):
        ...
        input_png_list = glob.glob("./modulos/pytikz/recursos/crear_imagen/grafica_recortada/*.jpg")
        input_png_list.sort()
        ...
        if (len(clips) > 0):
            ...
            if len(clips) == 1:
                concat_clip.write_gif('./imagenes_usuario/imagen_generado_id-'+id+'.jpg', fps=2, logger=my_bar_logger)
            #Es una secuencia de imagenes - GENERAR GIF
            else:
                concat_clip.write_gif('./imagenes_usuario/imagen_generado_id-'+id+'.gif', fps=2, logger=my_bar_logger)
