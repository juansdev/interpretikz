...
# Librerias propias
from .herramientas.base_pytikz import BasePytikz
from .herramientas.validadores import Validadores
from .herramientas.validador_pytikz.relleno import Relleno
from .herramientas.validador_pytikz.relleno_lineas_libre import RellenoLineasLibre
from .herramientas.validador_pytikz.guardar_dibujo_en_formato import GuardarDibujoEnImagen
from .herramientas.evaluar import Evaluar
...
class ValidadorPytikz(BasePytikz):
    ...
    def __init__(self,area_de_dibujar):
        ...
        #Instanciar clases herramientas
